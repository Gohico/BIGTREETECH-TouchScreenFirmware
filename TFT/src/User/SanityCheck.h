...
#define CUSTOM_GCODE_ENABLED                                                                    \
    {                                                                                           \
        ENABLE_CUSTOM0, ENABLE_CUSTOM1, ENABLE_CUSTOM2, ENABLE_CUSTOM3, ENABLE_CUSTOM4,         \
...
#define CUSTOM_GCODE_LIST                                                                       \
    {                                                                                           \
        CUSTOM_0_GCODE, CUSTOM_1_GCODE, CUSTOM_2_GCODE, CUSTOM_3_GCODE, CUSTOM_4_GCODE,         \
...
#define CUSTOM_GCODE_LABELS                                                                     \
    {                                                                                           \
        CUSTOM_0_LABEL, CUSTOM_1_LABEL, CUSTOM_2_LABEL, CUSTOM_3_LABEL, CUSTOM_4_LABEL,         \
